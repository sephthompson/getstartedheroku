...
class PgDatabase implements Database
{
	...
	public function executeQueryParams($statement, $params) {
		$res = @pg_query_params($this->conn, $statement, $params);
		return $res;
	}
	public function freeQuery($res) {
		@pg_free_result($res);
	}
	public function numRowsAffected($res) {
	...
	public function insertEx($table, $fieldsArray, $valuesArray) {
		$fields = "(".implode(", ", $fieldsArray).")";
